...
export class AddExerciseType1763283620498 implements MigrationInterface {
    name = 'AddExerciseType1763283620498'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."exercise_type_enum" RENAME TO "exercise_type_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."exercise_type_enum" AS ENUM('MULTIPLE_CHOICE', 'MULTIPLE_CHOICE_IMGS', 'MATCHING', 'TRANSLATION', 'LISTENING', 'SPEAKING', 'FILL_BLANK', 'REORDER', 'TRUE_FALSE')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."exercise_type_enum_old" AS ENUM('MULTIPLE_CHOICE', 'MATCHING', 'TRANSLATION', 'LISTENING', 'SPEAKING', 'FILL_BLANK', 'REORDER', 'TRUE_FALSE')`);
        await queryRunner.query(`ALTER TABLE "exercise" ALTER COLUMN "type" DROP DEFAULT`);
